...
--   jperez    / Sedes2026*Oruro    (administrador: panel completo)
--   mcondori  / Altas2026*Oruro    (operador del Hospital Walter Khon)
--
...
INSERT INTO usuarios (username, nombre_completo, ci, telefono, correo, rol,
                      red_salud, nombre_establecimiento, password_hash, activo)
VALUES
  ('jperez',
   'Juan Pérez Mamani',
   '4821567 OR',
   ...
   'administrador',
   NULL, NULL,                      -- el administrador no se ata a ningun establecimiento
  ...
  ('mcondori',
   ...
   'operador',
   'Red Urbana', 'Hospital Walter Khon',
